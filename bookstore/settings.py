...
# SECRET_KEY = 'django-insecure-8%9vns^p1m$5$e&-2+!f^)ein+6mqtv98na&bfjxi4lc-lk88z'
...
# # Add your Cloudinary URL (use environment variable on Render)
# CLOUDINARY_URL = os.getenv('CLOUDINARY_URL')

# # # Static (already handled locally)
# # STATIC_URL = '/static/'

# # # Media URL (points to Cloudinary now)
# # MEDIA_URL = '/media/'
